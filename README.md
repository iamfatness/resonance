...
- `src/components/` contains extracted UI surfaces such as the landing page, YouTube deck, search results, sidebar panels, queue panel, EQ/plugin panel, and desktop engine panel.
