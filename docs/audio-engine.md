...
- `--render-tone --duration-ms 250` generates two quiet deck test tones, applies per-deck gain and pan, mixes them into the WASAPI render buffer, and reports per-deck/master peaks.
